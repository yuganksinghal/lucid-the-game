...
public class Lucid extends Game{
	...
	public Lucid() {
		...
		cross.addDialogLine("You place the cross in its receptacle on the wall.");
		cross.addDialogLine("You feel something change...");
		cross.addDialogLine("Somehere far away.");
