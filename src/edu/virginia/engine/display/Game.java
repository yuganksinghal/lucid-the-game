...
public class Game extends DisplayObject implements ActionListener, KeyListener, IEventListener  {
	...
	public void setUpMainFrame(String gameId, int width, int height) {
		...
		System.out.println("Frame Size   : " + getMainFrame().getSize() );
        System.out.println("Frame Insets : " + getMainFrame().getInsets() );
        System.out.println("Content Size : " + getMainFrame().getContentPane().getSize() );
	}
